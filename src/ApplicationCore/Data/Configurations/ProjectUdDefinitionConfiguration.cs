...
{
    public class ProjectUdDefinitionConfiguration : IEntityTypeConfiguration<ProjectUdDefinition>
    {
        public void Configure(EntityTypeBuilder<ProjectUdDefinition> builder)
        {
