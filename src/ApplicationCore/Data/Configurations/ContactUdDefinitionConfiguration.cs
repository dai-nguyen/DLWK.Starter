...
{
    public class ContactUdDefinitionConfiguration : IEntityTypeConfiguration<ContactUdDefinition>
    {
        public void Configure(EntityTypeBuilder<ContactUdDefinition> builder)
        {
